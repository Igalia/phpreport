 ...
 */
$sqlFiles = array();
$sqlFiles[] = SQLPATH . "delete-cascade-user-assignment-to-projects.sql";
$sqlFiles[] = SQLPATH . "bump-db-version-2-23.sql";

// run upgrade scripts

require_once(PHPREPORT_ROOT . 'config/config.php');

if (strcmp(get_db_version(DB_HOST, DB_PORT, DB_NAME, DB_USER, DB_PASSWORD), "2.22") != 0) {
    print("Wrong database version. " .
        "Make sure DB is on 2.22 version before running this upgrade.\n");
    exit();
}
