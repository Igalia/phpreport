...
class CustomStoryVOTests extends PHPUnit_Framework_TestCase
{
    ...
    public function testIterationIdField()
    {
        ...
        $this->assertEquals($this->VO->getIterationId(), 2);

        $this->VO->setIterationId(45);
