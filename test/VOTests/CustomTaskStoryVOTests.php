...
class CustomTaskStoryVOTests extends PHPUnit_Framework_TestCase
{
    ...
    public function testTaskSectionField()
    {

        $taskSection = new TaskSectionVO();
        $taskSection->setName('Delivery');

        $this->VO->setTaskSection($taskSection);

        $this->assertEquals($this->VO->getTaskSection(), $taskSection);

        $taskSection->setName('Packaging');
