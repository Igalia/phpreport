...
class PostgreSQLModuleDAOBasicTests extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->dao = new PostgreSQLModuleDAO();

        $this->testObjects[0] = new ModuleVO();
    ...
    public function testGetByProjectIdFromProject()
    {
        ...
        $read = $this->auxDao->getModules($this->auxObject->getId());
