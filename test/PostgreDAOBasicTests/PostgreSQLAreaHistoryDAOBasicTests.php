...
class PostgreSQLAreaHistoryDAOBasicTests extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->dao = new PostgreSQLAreaHistoryDAO();

        $this->testObjects[0] = new AreaHistoryVO();
        ...
        $this->testObjects[0]->setAreaId($this->auxObject2->getId());
    ...
    public function testGetByUserId()
    {
        ...
        $this->testObjects[1]->setAreaId($this->auxObject2->getId());

        $this->testObjects[2] = new AreaHistoryVO();
        ...
        $this->testObjects[2]->setAreaId($this->auxObject2->getId());
    ...
    public function testGetByIntervals2()
    {
        ...
        $this->testObjects[1] = new AreaHistoryVO();
        $this->testObjects[1]->setId(-1);
        $this->testObjects[1]->setInitDate(date_create("2000-12-30"));
        ...
        $testObject->setAreaId($this->auxObject2->getId());
    ...
    public function testGetByAreaIdVoid()
    {
    ...
    public function testGetByUserIdFromUser()
    {
        ...
        $read = $this->auxDao->getAreaHistory($this->auxObject->getId());
    ...
    public function testGetByAreaIdFromArea()
    {
        ...
        $read = $this->auxDao2->getAreaHistories($this->auxObject2->getId());
