...
class PostgreSQLCommonEventDAOBasicTests extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->auxDao = new PostgreSQLCityDAO();

        $this->auxObject = new CityVO();
        $this->auxObject->setName("New New York");

        $this->auxDao->create($this->auxObject);

        $this->dao = new PostgreSQLCommonEventDAO();

        $this->testObjects[0] = new CommonEventVO();
        $this->testObjects[0]->setCityId($this->auxObject->getId());
    ...
    public function testGetByCityId()
    {
        ...
        $this->testObjects[1] = new CommonEventVO();
        $this->testObjects[1]->setCityId($this->auxObject->getId());
        $this->testObjects[1]->setDate(date_create("2000-12-31"));
        $this->testObjects[1]->setId(-1);

        $this->testObjects[2] = new CommonEventVO();
        $this->testObjects[2]->setCityId($this->auxObject->getId());
        $this->testObjects[2]->setDate(date_create("2001-12-31"));
        ...
        $read = $this->dao->getByCityId($this->auxObject->getId());
    ...
    public function testGetByCityIdFromCity()
    {
        ...
        $read = $this->auxDao->getCommonEvents($this->auxObject->getId());
