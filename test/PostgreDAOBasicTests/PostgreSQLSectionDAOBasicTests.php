...
class PostgreSQLSectionDAOBasicTests extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->auxDao = new PostgreSQLModuleDAO();

        $this->auxObject = new ModuleVO();
        ...
        $this->dao = new PostgreSQLSectionDAO();

        $this->testObjects[0] = new SectionVO();
        $this->testObjects[0]->setModuleId($this->auxObject->getId());
        $this->testObjects[0]->setName("Earth");
        $this->testObjects[0]->setText("Deliveries on Earth");
    ...
    public function testGetByModuleId()
    {
        ...
        $read = $this->dao->getByModuleId($this->auxObject->getId());

        $this->assertEquals($read, $this->testObjects);

    }

    public function testGetByModuleIdFromModule()
    {
        ...
        $read = $this->auxDao->getSections($this->auxObject->getId());
