...
class PostgreSQLJourneyHistoryDAOBasicTests extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->dao = new PostgreSQLJourneyHistoryDAO();

        $this->testObjects[0] = new JourneyHistoryVO();
        ...
        $this->testObjects[0]->setJourney(2);
    ...
    public function testGetByUserId()
    {
        ...
        $this->testObjects[1] = new JourneyHistoryVO();
        ...
        $this->testObjects[1]->setJourney(3);

        $this->testObjects[2] = new JourneyHistoryVO();
        ...
        $this->testObjects[2]->setJourney(5);
    ...
    public function testGetByIntervals2()
    {
        ...
        $testObject = new JourneyHistoryVO();
        $testObject->setId(-1);
    ...
    public function testGetByUserIdFromUser()
    {
        ...
        $read = $this->auxDao->getJourneyHistory($this->auxObject->getId());
