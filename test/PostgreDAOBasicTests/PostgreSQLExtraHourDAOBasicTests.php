...
class PostgreSQLExtraHourDAOBasicTests extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->auxObject->setId(-1);

        $this->auxDao->create($this->auxObject);

        $this->dao = new PostgreSQLExtraHourDAO();

        $this->testObjects[0] = new ExtraHourVO();
    ...
    public function testGetLastByUserId()
    {

        $this->testObjects[1] = new ExtraHourVO();
        $this->testObjects[1]->setUserId($this->auxObject->getId());
        $this->testObjects[1]->setHours(2.45);
        $this->testObjects[1]->setDate(date_create("2001-12-31"));
        $this->testObjects[1]->setId(-1);

        $this->testObjects[2] = new ExtraHourVO();
        $this->testObjects[2]->setUserId($this->auxObject->getId());
        $this->testObjects[2]->setHours(2.45);
        $this->testObjects[2]->setDate(date_create("2000-12-31"));
        $this->testObjects[2]->setId(-1);
        ...
        $read = $this->dao->getLastByUserId($this->auxObject->getId(), new DateTime());
    ...
    public function testGetByUserIdFromUser()
    {
        ...
        $read = $this->auxDao->getExtraHours($this->auxObject->getId());
