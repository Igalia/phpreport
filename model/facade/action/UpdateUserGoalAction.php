...
//$userGoalVo->setId( 2 );
//$userGoalVo->setExtraHours( 500 );
//$userGoalVo->setUserId(1);
//$userGoalVo->setInitDate(date_create("2009-01-01"));
//$userGoalVo->setEndDate(date_create("2009-06-01"));
//$action= new UpdateUserGoalAction($userGoalVo);
//var_dump($action);
//$action->execute();
//var_dump($userGoalVo);
