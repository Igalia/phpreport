...
/** File for GetProjectsAndCustomersByUserLoginAction
 *
 *  This file just contains {@link GetProjectsAndCustomersByUserLoginAction}.
 *
 * @filesource
 * @package PhpReport
 * @subpackage facade
 ...
 * @subpackage facade
 */
class GetProjectsAndCustomersByUserLoginAction extends Action{
	...
	public function __construct($customerId, $userLogin = NULL, $active = False, $order = 'id') {
		...
		$this->order = $order;
		$this->preActionParameter="GET_PROJECTS_AND_CUSTOMER_BY_USER_LOGIN_PREACTION";
		$this->postActionParameter="GET_PROJECTS_AND_CUSTOMER_BY_USER_LOGIN_POSTACTION";
	}
	...
	protected function doExecute() {
		...
		return $dao->getProjectsAndCustomersByUserLogin($this->userLogin, $this->active, $this->order);
	}
