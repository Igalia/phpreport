...
/** File for GetGlobalUsersStoriesReportAction
 *
 *  This file just contains {@link GetGlobalUsersStoriesReportAction}.
 *
 * @filesource
 * @package PhpReport
 * @subpackage facade
 ...
 *
 *  This action is used for retrieving information about worked hours in Tasks done by Users for each Story.
 *
 * @package PhpReport
 * @subpackage facade
 * @author Jorge López Fernández <jlopez@igalia.com>
 */
class GetGlobalUsersStoriesReportAction extends Action{
    ...
    /** GetGlobalUsersStoriesReportAction constructor.
     *
    ...
    if (is_null($end))
        ...
        $this->preActionParameter="GET_GLOBAL_USERS_STORIES_REPORT_PREACTION";
        $this->postActionParameter="GET_GLOBAL_USERS_STORIES_REPORT_POSTACTION";
    ...
    protected function doExecute() {
        ...
        $doubleResults = $dao->getGlobalTaskReport($this->init, $this->end, "USER", "STORY");

        foreach ($doubleResults as $doubleResult)
        {

            $story = (is_null($doubleResult['story'])) ? '--- Unknown ---' : $doubleResult['story'];
            ...
            $results[$userLogin][$story] =  $doubleResult['add_hours'];
...
$action= new GetGlobalUsersStoriesReportAction();
//var_dump($action);
