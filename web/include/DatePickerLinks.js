 ...
 * @xtype datepicker
 */
Ext.DatePickerLinks = Ext.extend(Ext.BoxComponent, {
    /**
     * @cfg {String} baseUrl
     * The base URL to concat (please note that no separators are added) with the date in format 'YYYY-MM-DD'
     */
    ...
    onRender : function(container, position){
        ...
        for(i = 0; i < 42; i++) {
            ...
            m[m.length] = '<td><a href="pepe" hidefocus="on" class="x-date-date" tabIndex="1"><em><span></span></em></a></td>';
        }
        ...
        // We no longer need the event as the calendar has real links now
    ...
    update : function(date, forceRefresh){
        if(this.rendered){
            ...
            // We must create the elements for event handling as some HTML
            // attributes have been directly modified
            this.eventEl = Ext.get(this.el.firstChild);
...
Ext.reg('datepickerlinks', Ext.DatePickerLinks);
