...
/** createJourneyHistories web service.
 *
 * @filesource
 * @package PhpReport
 * @subpackage services
 ...
 */
    ...
    /*$request = '<?xml version="1.0" encoding="ISO-8859-15"?><journeyHistories><journeyHistory><userId>81</userId><journey>7</journey><init format="Y-m-d">2009-06-01</init><end format="Y-m-d">2009-12-01</end></journeyHistory><journeyHistory><userId>81</userId><journey>4</journey><init format="Y-m-d">2009-01-01</init><end format="Y-m-d">2009-06-01</end></journeyHistory></journeyHistories>';*/
    ...
    do {
        ...
        if (!$user)
        {
            $string = "<return service='createJourneyHistories'><error id='2'>You must be logged in</error></return>";
            break;
        }

        if (!LoginManager::isAllowed($sid))
        {
            $string = "<return service='createJourneyHistories'><error id='3'>Forbidden service for this User</error></return>";
            break;
        }
        ...
        do {
            ...
            if ($parser->name == "journeyHistory")
            {
                ...
                $createJourneyHistories[] = $journeyHistoryVO;
        ...
        if (count($createJourneyHistories) >= 1)
            ...
            {
                if (UsersFacade::CreateJourneyHistory($journeyHistory) == -1)
                {
                    $string = "<return service='createJourneyHistories'><error id='1'>There was some error while creating the journey history entries</error></return>";
                    break;
                }
            }
