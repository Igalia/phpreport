 ...
 */
    ...
    /*$request = '<?xml version="1.0" encoding="ISO-8859-15"?><users><user><id>65</id><login>chorro</login><userGroups><admin>true</admin><staff>true</staff></userGroups></user></users>';*/
    ...
    do {
        ...
        if (!$user)
        {
            $string = "<return service='createUsers'><error id='2'>You must be logged in</error></return>";
            break;
        }

        if (!LoginManager::isAllowed($sid))
        {
            $string = "<return service='createUsers'><error id='3'>Forbidden service for this User</error></return>";
            break;
        }
