 ...
 */
   ...
   do {
        ...
        {
            $string = "<users aid='$aid'><error id='2'>You must be logged in</error></users>";
            break;
        }

        if (!LoginManager::isAllowed($sid))
        {
            $string = "<users aid='$aid'><error id='3'>Forbidden service for this User</error></users>";
            break;
        }

        $users = UsersFacade::GetUsersByAreaIdDate($aid, new DateTime());

        $string = "<users aid='$aid'>";
