...
/** createHourCostHistories web service.
 *
 * @filesource
 * @package PhpReport
 * @subpackage services
 ...
 */
    ...
    /*$request = '<?xml version="1.0" encoding="ISO-8859-15"?><hourCostHistories><hourCostHistory><userId>81</userId><hourCost>7.56</hourCost><init format="Y-m-d">2009-06-01</init><end format="Y-m-d">2009-12-01</end></hourCostHistory><hourCostHistory><userId>81</userId><hourCost>4.33</hourCost><init format="Y-m-d">2009-01-01</init><end format="Y-m-d">2009-06-01</end></hourCostHistory></hourCostHistories>';*/
    ...
    do {
        ...
        if (!$user)
        {
            $string = "<return service='createHourCostHistories'><error id='2'>You must be logged in</error></return>";
            break;
        }

        if (!LoginManager::isAllowed($sid))
        {
            $string = "<return service='createHourCostHistories'><error id='3'>Forbidden service for this User</error></return>";
            break;
        }
        ...
        do {
            ...
            if ($parser->name == "hourCostHistory")
            {
                ...
                $createHourCostHistories[] = $hourCostHistoryVO;
        ...
        if (count($createHourCostHistories) >= 1)
            foreach((array)$createHourCostHistories as $hourCostHistory)
            {
                if (UsersFacade::CreateHourCostHistory($hourCostHistory) == -1)
                {
                    $string = "<return service='createHourCostHistories'><error id='1'>There was some error while creating the hour cost history entries</error></return>";
                    break;
                }
            }
        ...
        if (!$string)
        {
            ...
            $string = "<return service='createHourCostHistories'><ok>Operation Success!</ok><hourCostHistories>";
