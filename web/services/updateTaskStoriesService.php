 ...
 */
    ...
    /*$request = '<?xml version="1.0" encoding="ISO-8859-15"?><taskStories><taskStory><id>6</id><initDate>2009-10-01</initDate><endDate>2009-10-25</endDate><estEndDate>2009-10-29</estEndDate><risk>2</risk><toDo>10.5</toDo><estHours>50</estHours><name>Gallina marica</name><userId>81</userId><taskSectionId/><storyId>1</storyId></taskStory><taskStory><id>5</id><initDate>2008-10-01</initDate><endDate>2008-10-25</endDate><estEndDate>2008-10-29</estEndDate><risk>0</risk><toDo>5</toDo><estHours>30</estHours><name>This is Igalia!!</name><userId>75</userId><taskSectionId/><storyId>1</storyId></taskStory></taskStories>';*/
    ...
    do {
        ...
        if (!$user)
        {
            $string = "<return service='updateTaskStories'><error id='2'>You must be logged in</error></return>";
            break;
        }

        if (!LoginManager::isAllowed($sid))
        {
            $string = "<return service='updateTaskStories'><error id='3'>Forbidden service for this User</error></return>";
            break;
        }
        ...
        if (count($updateTaskStories) >= 1)
            foreach((array)$updateTaskStories as $taskStory)
                if (CoordinationFacade::UpdateTaskStory($taskStory) == -1)
                {
                    $string = "<return service='updateTaskStories'><error id='1'>There was some error while updating the task stories</error></return>";
                    break;
                }
        ...
        if (!$string)
        {
            ...
            $string = "<return service='updateTaskStories'><ok>Operation Success!</ok><taskStories>";

            foreach((array) $updateTaskStories as $updateTaskStory)
            {

                $taskStory = CoordinationFacade::GetCustomTaskStory($updateTaskStory->getId());
